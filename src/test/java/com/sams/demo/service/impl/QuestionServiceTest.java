...
import com.sams.demo.AbstractUnitTest;
import com.sams.demo.TestBeanConfiguration;
...
class QuestionServiceTest {
    ...
    private static final Pageable defaultPageable = of(DEFAULT_PAGE_NUMBER, DEFAULT_PAGE_SIZE);
    private static final Pageable allResultsPageable = of(DEFAULT_PAGE_NUMBER, (int)QUESTIONS_NUMBER + 1);
    ...
    class FindAll extends AbstractUnitTest {
        ...
        void findAll_notAuthenticated_withDefaultLocaleAndDefaultPageable() {
            ...
            Page<ReadAllQuestionDTO> questions =
                    questionService.findAll(null, EN.getValue(), defaultPageable);
        ...
        void findAll_notAuthenticated_withDefaultLocaleAndAllResultsPageable() {
            ...
            //when
            Page<ReadAllQuestionDTO> questions =
                    questionService.findAll(null, EN.getValue(), allResultsPageable);
    ...
    class FindAllForTranslation extends AbstractUnitTest {
        ...
        void findAllForTranslation_notAuthenticated_withDefaultLocaleAndDefaultPageable() {
            ...
            assertThrows(AuthenticationCredentialsNotFoundException.class,
                    () -> questionService.findAllForTranslation(EN.getValue(), defaultPageable));
        }
        ...
        void findAllForTranslation_authenticatedAsTranslator_withDefaultLocaleAndDefaultPageable() {
            ...
            assertEquals(SENIOR.name().toUpperCase(),
    ...
    class FindById extends AbstractUnitTest {
        ...
        @ParameterizedTest
        @MethodSource("com.sams.demo.service.impl.QuestionServiceTest#userQuestionIds")
        ...
        @ParameterizedTest
        @MethodSource("com.sams.demo.service.impl.QuestionServiceTest#adminQuestionIds")
        ...
        @ParameterizedTest
        @MethodSource("com.sams.demo.service.impl.QuestionServiceTest#translatorQuestionIds")
        ...
        @ParameterizedTest
        @MethodSource("com.sams.demo.service.impl.QuestionServiceTest#moderatorQuestionIds")
